...
func _ready():
	...
	backgroundTexture = load("res://Estrelas/Céu_Estrelado.png")  # Substitua pelo caminho correto da sua textura
...
func _draw() -> void:
	# Desenhar o fundo do céu estrelado
	draw_texture(backgroundTexture, Vector2.ZERO)  # Desenha o fundo na posição (0,0)
